...
| 术语 | 定义 |
|------|------|
| 本地LLM | 运行在用户本地环境的大语言模型，通过Ollama提供服务 |
...
| 功能点 | 详细描述 | 验收标准 |
|--------|----------|----------|
| **路径判断** | 根据澄清后的最终问题，由本地LLM判断最优执行路径 | 1. 路径判断准确率≥80%<br>2. 决策时间≤15秒 |
| **直接回答** | 对于简单问题，直接由本地LLM生成答案，全程无网络请求 | 1. 简单问题识别准确率≥85%<br>2. 答案生成时间≤30秒 |
...
| **兼容性** | 支持多种操作系统和环境 | 1. 支持Windows 10/11<br>2. 支持Python 3.12+<br>3. 支持Ollama 0.1.0+ |
